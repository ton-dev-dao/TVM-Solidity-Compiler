 ...
 * [format()](API.md#format) threw an exception for non `addr_std` address. See [issues #168](https://github.com/ton-dev-dao/TVM-Solidity-Compiler/issues/168). 
Now [format()](API.md#format) can take address of any type. 
 * Fixed bug when you iterate over array of mapping. See [issues #169](https://github.com/ton-dev-dao/TVM-Solidity-Compiler/issues/169).
 * Fixed bug when overloading inline function. See [issues #167](https://github.com/ton-dev-dao/TVM-Solidity-Compiler/issues/167).
...
Bugfixes:
 * Peephole optimizer generated invalid code. See [issue #153](https://github.com/ton-dev-dao/TVM-Solidity-Compiler/issues/153).
...
Support ABI 2.1:
 * Field `fields` appeared in abi file. You can parse state variable. See `ton-dev-cli decode account --help`.
